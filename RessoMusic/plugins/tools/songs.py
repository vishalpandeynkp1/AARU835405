...
from RessoMusic.utils.formatters import convert_bytes
from RessoMusic.utils.inline.song import song_markup
...
SONG_DOWNLOAD_DURATION_LIMIT = 9999
...
async def song_download_cb(client, CallbackQuery, _):
    ...
    with yt_dlp.YoutubeDL({"quiet": True, "cookiefile" : cookie_txt_file()}) as ytdl:
